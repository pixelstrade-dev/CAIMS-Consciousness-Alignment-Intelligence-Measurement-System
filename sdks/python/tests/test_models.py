...
API_DATA = {
    "scores": {
        "cq": {"score": 81.0, "details": {"integration_depth": 80, "knowledge_breadth": 70, "metacognitive_display": 75, "synthesis": 60, "temporal_coherence": 65}},
    ...
    "metadata": {
        ...
        "latencyMs": 2100,
        "protocolVersion": "3.0.0-alpha",
        "promptHash": "69891355495852dd",
        "provider": "anthropic",
        "temperature": None,
...
def test_parses_full_result():
    ...
    assert r.cq.details["integration_depth"] == 80
...
def test_provenance_envelope_incl_null_temperature():
    ...
    assert p.protocol_version == "3.0.0-alpha"
    assert p.prompt_hash == "69891355495852dd"
