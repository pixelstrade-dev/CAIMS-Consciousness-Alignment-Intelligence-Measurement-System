...
const FILES = [
  ...
  'statistics/agreement.ts',
  'statistics/simulation.ts',
  'verifiers/citations.ts',
  'statistics/__tests__/descriptive.test.ts',
  'statistics/__tests__/agreement.test.ts',
  'statistics/__tests__/simulation.test.ts',
  'verifiers/__tests__/citations.test.ts',
  ...
  'scorers/__tests__/evidence-card.test.ts',
  'scorers/__tests__/piga.test.ts',
